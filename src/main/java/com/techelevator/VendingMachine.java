...
public class VendingMachine {
    ...
    public String returnChange() {
        ...
        double balanceAsDouble = this.getBalance().doubleValue();
        int quarters = (int) (balanceAsDouble / 0.25);
        balanceAsDouble -= (quarters * 0.25);
        int dimes = (int) (balanceAsDouble / 0.10);
        balanceAsDouble -= (dimes * 0.10);
        int nickels = (int) (balanceAsDouble / 0.05);
